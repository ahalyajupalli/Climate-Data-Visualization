        ...
        <div className="row">
          ...
          <div className="col-md-3">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">Average Minimum Temperature in Edmonton over 23 years(2000-2024)</p>
          ...
          <div className="col-md-3">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">Average Maximum Temperature in Edmonton over 23 years(2000-2024)</p>
          ...
          <div className="col-md-3">
            <div className="card">
              ...
              <div className="card-body">
                <h5 className="card-title">Average SnowFall</h5>
                <p className="card-text">Average Snowfall on Ground in Edmonton over 23 years(2000-2024)</p>
